...
```bash
# Simple skill
/home/wallase16/pai-bridge/Personal_AI_Infrastructure/.claude/skills/[skill-name]/
└── SKILL.md
...
For detailed context: `read /home/wallase16/pai-bridge/Personal_AI_Infrastructure/.claude/skills/[skill-name]/CLAUDE.md`
```
...
Update `/home/wallase16/pai-bridge/Personal_AI_Infrastructure/.claude/global/KAI.md` available_skills section to include the new skill so it shows up in the system prompt.
...
For complete guide with examples: `read /home/wallase16/pai-bridge/Personal_AI_Infrastructure/.claude/skills/create-skill/CLAUDE.md`
For templates: `ls /home/wallase16/pai-bridge/Personal_AI_Infrastructure/.claude/skills/create-skill/templates/`
