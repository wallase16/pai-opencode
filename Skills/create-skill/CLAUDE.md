...
- Live in `/home/wallase16/pai-bridge/Personal_AI_Infrastructure/.claude/commands/`
...
```
/home/wallase16/pai-bridge/Personal_AI_Infrastructure/.claude/skills/fabric-patterns/
...
```
/home/wallase16/pai-bridge/Personal_AI_Infrastructure/.claude/skills/development/
...
For full context: `read /home/wallase16/pai-bridge/Personal_AI_Infrastructure/.claude/skills/[name]/CLAUDE.md`
For components: `read /home/wallase16/pai-bridge/Personal_AI_Infrastructure/.claude/skills/[name]/[subdirectory]/`
```
...
**For Simple Skill:**
```bash
mkdir -p /home/wallase16/pai-bridge/Personal_AI_Infrastructure/.claude/skills/[skill-name]
...
```bash
mkdir -p /home/wallase16/pai-bridge/Personal_AI_Infrastructure/.claude/skills/[skill-name]
mkdir -p /home/wallase16/pai-bridge/Personal_AI_Infrastructure/.claude/skills/[skill-name]/[component-dirs]
...
Edit `/home/wallase16/pai-bridge/Personal_AI_Infrastructure/.claude/global/KAI.md`:
```markdown
<available_skills>
<skill>
...
## Supplementary Resources
For advanced usage: `read /home/wallase16/pai-bridge/Personal_AI_Infrastructure/.claude/docs/[resource].md`
```
...
For full methodology: `read /home/wallase16/pai-bridge/Personal_AI_Infrastructure/.claude/skills/[name]/CLAUDE.md`
For components: `read /home/wallase16/pai-bridge/Personal_AI_Infrastructure/.claude/skills/[name]/[component]/`
...
**Voice:** [ElevenLabs ID]
**Configuration:** `/home/wallase16/pai-bridge/Personal_AI_Infrastructure/.claude/agents/[name].md`
...
## Supplementary Resources
For agent details: `read /home/wallase16/pai-bridge/Personal_AI_Infrastructure/.claude/agents/[name].md`
For methodology: `read /home/wallase16/pai-bridge/Personal_AI_Infrastructure/.claude/skills/[name]/CLAUDE.md`
```
...
## Advanced Usage
For comprehensive methodology: `read /home/wallase16/pai-bridge/Personal_AI_Infrastructure/.claude/skills/[name]/CLAUDE.md`

## Component Details
For [specific component]: `read /home/wallase16/pai-bridge/Personal_AI_Infrastructure/.claude/skills/[name]/[component]/`
```
...
### PAI Resources
- `/home/wallase16/pai-bridge/Personal_AI_Infrastructure/.claude/global/KAI.md` - Global context and available_skills
- `/home/wallase16/pai-bridge/Personal_AI_Infrastructure/.claude/agents/` - Agent configurations
- `/home/wallase16/pai-bridge/Personal_AI_Infrastructure/.claude/commands/` - Slash commands
- `/home/wallase16/pai-bridge/Personal_AI_Infrastructure/.claude/docs/` - MCP and tool documentation
