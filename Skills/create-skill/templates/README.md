...
```bash
cp /home/wallase16/pai-bridge/Personal_AI_Infrastructure/.claude/skills/create-skill/templates/[template-name].md \
   /home/wallase16/pai-bridge/Personal_AI_Infrastructure/.claude/skills/[new-skill-name]/SKILL.md
```
...
Update `/home/wallase16/pai-bridge/Personal_AI_Infrastructure/.claude/global/KAI.md` available_skills section.
...
- Complete guide: `read /home/wallase16/pai-bridge/Personal_AI_Infrastructure/.claude/skills/create-skill/CLAUDE.md`
- Quick reference: `read /home/wallase16/pai-bridge/Personal_AI_Infrastructure/.claude/skills/create-skill/SKILL.md`
- Example skills: `ls /home/wallase16/pai-bridge/Personal_AI_Infrastructure/.claude/skills/`
