...
The Fabric repository is included in this skill at `/home/wallase16/pai-bridge/Personal_AI_Infrastructure/.claude/skills/fabric/fabric-repo/`.

**To update patterns:**

```bash
cd /home/wallase16/pai-bridge/Personal_AI_Infrastructure/.claude/skills/fabric/fabric-repo
...
```bash
ls /home/wallase16/pai-bridge/Personal_AI_Infrastructure/.claude/skills/fabric/fabric-repo/data/patterns/
...
**Full Pattern List:** `ls /home/wallase16/pai-bridge/Personal_AI_Infrastructure/.claude/skills/fabric/fabric-repo/data/patterns/`
**Fabric Repo:** `/home/wallase16/pai-bridge/Personal_AI_Infrastructure/.claude/skills/fabric/fabric-repo/`
**Fabric Documentation:** https://github.com/danielmiessler/fabric
**Pattern Templates:** See `/home/wallase16/pai-bridge/Personal_AI_Infrastructure/.claude/skills/fabric/fabric-repo/data/patterns/official_pattern_template/`
